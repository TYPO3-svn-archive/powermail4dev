 ...
 ***************************************************************/
 ...
 /**
 * The class tx_powermail4dev_pi1_backend bundles methods for backend support like itemsProcFunc
 *
 ...
 *
 *
 *   49: class tx_powermail4dev_pi1_backend
 *
 *              SECTION: Sheets
 ...
 *
 */
class tx_powermail4dev_pi1_backend
{
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/powermail4dev/pi1/class.tx_powermail4dev_pi1_backend.php']) {
  include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/powermail4dev/pi1/class.tx_powermail4dev_pi1_backend.php']);
}
?>